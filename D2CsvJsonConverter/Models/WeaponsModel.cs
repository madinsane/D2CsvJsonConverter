...
namespace D2CsvJsonConverter.Models
{
    ...
    internal class WeaponsModel
    {
        ...
        [Name("1or2handed"), NameIndex(0), JsonProperty]
        public string _1Or2handed { get; set; } = "";
        
        [Name("2handed"), NameIndex(0), JsonProperty]
        public string _2Handed { get; set; } = "";
        
        [Name("2handmindam"), NameIndex(0), JsonProperty]
        public string _2Handmindam { get; set; } = "";
        
        [Name("2handmaxdam"), NameIndex(0), JsonProperty]
        public string _2Handmaxdam { get; set; } = "";
        
        [Name("minmisdam"), NameIndex(0), JsonProperty]
        public string Minmisdam { get; set; } = "";
        
        [Name("maxmisdam"), NameIndex(0), JsonProperty]
        public string Maxmisdam { get; set; } = "";
        
        [Name(""), NameIndex(0), JsonProperty]
        public string Unknown { get; set; } = "";
        
        [Name("rangeadder"), NameIndex(0), JsonProperty]
        public string Rangeadder { get; set; } = "";
        ...
        [Name("wclass"), NameIndex(0), JsonProperty]
        public string Wclass { get; set; } = "";
        
        [Name("2handedwclass"), NameIndex(0), JsonProperty]
        public string _2Handedwclass { get; set; } = "";
        
        [Name("component"), NameIndex(0), JsonProperty]
        public string Component { get; set; } = "";
        
        [Name("hit class"), NameIndex(0), JsonProperty]
